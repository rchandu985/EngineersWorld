...
class CreateChapters(models.Model):
    Qualification=models.CharField(max_length=1000,default='Degree')
...
class SaveDegreeMaterials(models.Model):
    ...
    File=models.FileField(upload_to='DegreeDatabase',null=True)
