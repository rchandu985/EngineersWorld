...
class CreateChapters(models.Model):
    Qualification=models.CharField(max_length=1000,default='Diploma')
...
class SaveDiplomaMaterials(models.Model):
    ...
    File=models.FileField(upload_to='DiplomaDatabase',null=True)
